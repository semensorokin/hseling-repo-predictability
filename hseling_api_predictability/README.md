...
## Development environment and release process
 ...
 - create virtualenv with Flask and Predictability installed into it (latter is installed in
...
install it (`pip install hseling_api_predictability.tar.gz`), ensure that configuration file exists and
`HSELING_API_PREDICTABILITY_SETTINGS` environment variable points to it, ensure that user has access to the
